...
echo -e "\n${GREEN}${BOLD}[1/4] Removing PM2 process...${NC}"
...
echo -e "\n${GREEN}${BOLD}[2/4] Removing Nginx config...${NC}"
...
echo -e "\n${GREEN}${BOLD}[3/4] Removing install directory...${NC}"
...
echo -e "\n${GREEN}${BOLD}[4/4] Upload directory${NC}"
...
echo
echo -e "${GREEN}${BOLD}\xe2\x9c\x93 tg-filehost uninstalled.${NC}"
